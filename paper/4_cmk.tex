...
\CatchFileBetweenTags{\CabibboSineVal}{calculations/constants.tex}{CabibboSineVal}
\CatchFileBetweenTags{\CabibboSineEq}{calculations/constants.tex}{CabibboSineEq}
\CatchFileBetweenTags{\CabibboSineExp}{calculations/constants.tex}{CabibboSineExperimentalValue}

\CatchFileBetweenTags{\VubVal}{calculations/constants.tex}{VubVal}
\CatchFileBetweenTags{\VubEq}{calculations/constants.tex}{VubEq}
\CatchFileBetweenTags{\VubExp}{calculations/constants.tex}{VubExperimentalValue}

\CatchFileBetweenTags{\VcbVal}{calculations/constants.tex}{VcbVal}
\CatchFileBetweenTags{\VcbEq}{calculations/constants.tex}{VcbEq}
\CatchFileBetweenTags{\VcbExp}{calculations/constants.tex}{VcbExperimentalValue}

\CatchFileBetweenTags{\VudVal}{calculations/constants.tex}{VudVal}
\CatchFileBetweenTags{\VudEq}{calculations/constants.tex}{VudEq}
\CatchFileBetweenTags{\VudExp}{calculations/constants.tex}{VudExperimentalValue}

\CatchFileBetweenTags{\VcsVal}{calculations/constants.tex}{VcsVal}
\CatchFileBetweenTags{\VcsEq}{calculations/constants.tex}{VcsEq}
\CatchFileBetweenTags{\VcsExp}{calculations/constants.tex}{VcsExperimentalValue}
...
$u \to d$ & $V_{ud}$ & $\VudEq$ & \textbf{\VudVal} & \VudExp & \textbf{99.99\%} \\
$u \to s$ & $V_{us}$ & $\CabibboSineEq$ & \textbf{\CabibboSineVal} & \CabibboSineExp & \textbf{99.73\%} \\
$u \to b$ & $V_{ub}$ & $\VubEq$ & \textbf{\VubVal} & \VubExp & \textbf{99.20\%} \\
\midrule
\multicolumn{6}{l}{\textit{Generation 2 (Dimensional Shift)}} \\
$c \to d$ & $V_{cd}$ & $V_{us}$ (Unitary Reflection) & \textbf{\CabibboSineVal} & $0.22480$ & \textbf{99.82\%} \\
$c \to s$ & $V_{cs}$ & $\VcsEq$ & \textbf{\VcsVal} & \VcsExp & \textbf{99.99\%} \\
$c \to b$ & $V_{cb}$ & $\VcbEq$ & \textbf{\VcbVal} & \VcbExp & \textbf{99.70\%} \\
\bottomrule
\end{tabular}
\end{table*}
...
\CatchFileBetweenTags{\VcdVal}{calculations/constants.tex}{VcdVal}
\CatchFileBetweenTags{\VtdVal}{calculations/constants.tex}{VtdVal}
\CatchFileBetweenTags{\VtsVal}{calculations/constants.tex}{VtsVal}
\CatchFileBetweenTags{\VtbVal}{calculations/constants.tex}{VtbVal}
...
\begin{itemize}
    ...
    \begin{equation}
    |V_{ts}| = |V_{cb}| \cdot \sqrt{1 - |V_{us}|^2}
    \end{equation}
\end{itemize}
