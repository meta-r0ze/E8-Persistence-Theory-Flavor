...
In the Standard Model, the unitarity of the CKM matrix is a mathematical requirement for probability conservation, valid only if the assumed number of generations is complete.  In the $E_8$-Persistence Theory, this conservation is structurally enforced by State Saturation. Because the lattice capacity is strictly limited to $v=16$ chiral channels, the closure of the 3-generation system is not an assumption, but a physical hardware limit.
