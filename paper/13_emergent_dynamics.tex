...
We postulate a unitary update rule based on the conservation of information flux, analogous to Kirchhoff's Current Law in network theory. This approach is formally equivalent to a Quantum Lattice Gas Automaton (QLGA)\cite{meyer_quantum_1996} or the discrete Feynman Checkerboard model \cite{feynman_quantum_1965}, extended here to the $E_8$ geometry.
