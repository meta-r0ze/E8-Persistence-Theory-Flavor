...
The derivations in this work establish the static boundary conditions of the vacuum. To demonstrate that these boundaries dictate the correct dynamic evolution, we performed an \textit{ab initio} computational audit of the discrete lattice evolution.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{lattice_water_audit.png}
